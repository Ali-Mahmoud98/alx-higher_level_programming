#!/usr/bin/python3
"""base.py unit testing using unittest."""
import os
import unittest
...
class test_BaseInit(unittest.TestCase):
    ...
    def test_noArgs2(self):
        ...
        base3 = Base()
        base4 = Base()
        self.assertEqual(base4.id, base1.id + 2)
    ...
    def test_str_id(self):
        self.assertEqual("ali", Base("ali").id)
    ...
    def test_dict_id(self):
        self.assertEqual({"a": 5, "b": 2}, Base({"a": 5, "b": 2}).id)

    def test_bool_id(self):
        self.assertEqual(True, Base(True).id)

    def test_list_id(self):
        self.assertEqual([5, 2, 3], Base([5, 2, 3]).id)
